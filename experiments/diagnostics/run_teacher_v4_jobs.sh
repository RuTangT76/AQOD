...
training=/root/trust_mvp/reports/aqod-teacher-v4-budget-run1
sha256sum -c <<'HASHES'
...
PY
  ...
  evaluate teacher_rl models/Qwen3.5-9B reports/aqod-gate-t-v4-rl-run1 --adapter "$checkpoint"
  ;;
controls)
  export CUDA_VISIBLE_DEVICES=1
  test ! -e reports/aqod-gate-t-v4-raw-run1
  test ! -e reports/aqod-gate-t-v4-student-run1
  echo "$(date -u +%FT%TZ) V4 controls wrapper PID $$"
  evaluate teacher_raw models/Qwen3.5-9B reports/aqod-gate-t-v4-raw-run1
  evaluate student_base models/Qwen3.5-2B reports/aqod-gate-t-v4-student-run1
  ;;
