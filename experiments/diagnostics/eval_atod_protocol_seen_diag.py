...
frozen valid_seen sample, and generation uses local Transformers.
"""
...
from trustlab.alfworld_bridge_seen import EnvironmentClient
...
def run(args):
    ...
    run_doc = {
        ...
        "selection": selection,
        "panel": "official valid_seen; separate outcome-independent 30-game panel",
        ...
        "caveat": "ATOD's default evaluation is in-distribution; this is a separate valid_seen subset, not the authors' exact validation panel."
    }
